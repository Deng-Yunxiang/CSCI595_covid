...
class GooglenetFineTuning(LightningModule):
    """
    ...
    def __init__(self, input_shape):
        ...
        # Initializing a pretrained googlenet model.
...
"""Generate googlenet model"""
def generateModel():
    CHECKPOINT_ROOT = BASE / "checkpoints" 
    model = GooglenetFineTuning((3,224,224))
