...
class SqueezenetTransferLearning(LightningModule):
    ...
    def __init__(self, input_shape):
        ...
        # Initializing a pretrained squeezenet1.1 model.
...
if __name__ == "__main__":
    ...
    bag_train_loader = bagging_loader(trainset)
    bag_val_loader = bagging_loader(valset)
    generatebaggingModels(MODEL_NUM)
