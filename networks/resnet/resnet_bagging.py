...
DICT_PATH = BASE / "resnet18.pth"

BATCH_SIZE = 8

# Models participating in Bagging. In this case, 10 models 
# with best validation accuracy are selected
MODEL_LIST = [5, 6, 7, 9, 10, 12, 13, 14 ,16, 20]
...
def models_bagging():
    ...
    for n in MODEL_LIST:
        ...
        model = ResnetTransferLearning.load_from_checkpoint(model_path)
